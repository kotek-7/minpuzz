...
export const Top = () => {
  ...
  return (
    ...
    >
      ...
      <div className="bg-[#e0f8fb] px-2 py-8 min-h-[600px] text-center">
        ...
        <div className="flex justify-center gap-[20px]">
          ...
          text-[#4a2c00] bg-[#ffba39] border-[#8a5a00] shadow-[0_4px_8px_#ffba39] active:shadow-[0_2px_4px_#ffba39] active:translate-y-[5px]`}
            ...
            <div className="text-gray-500 text-sm mt-4">チームのうち1人はここから参加！</div>
          ...
          <div className="w-full flex-col flex items-center">
            ...
            <div className="text-gray-500 text-sm mt-4">チームの残りの人はここから参加！</div>
          </div>
        </div>
      </div>
    </div>
