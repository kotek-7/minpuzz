    ...
    >
      ...
      <div className="w-full bg-white border-2 border-[#00bcd4] rounded-xl p-6 text-center shadow-xl">
        ...
        <button
          ...
          className="mt-8 px-8 py-3 bg-[#ffba39] font-bold rounded-xl shadow-[0_4px_8px_#ffba39] active:shadow-[0_2px_4px_#ffba39] active:translate-y-1 border-2 border-[#8a5a00]"
        >
          マッチング開始！
        </button>
      </div>
      <p className="leading-relaxed text-center mt-8">
        他のプレイヤーにチーム番号を共有してメンバーを集めましょう
        <br />
        3人 or 4人でゲーム開始可能です
      </p>
